...
class Complex{
    ...
    public:
        ...
        bool operator > (const Complex &obj) const{
            if(this->real>obj.real || (this->real==obj.imag && this->imag>obj.imag)){
                return true;
            }
            return false;
        }
...
class Student{
    ...
    public:
        ...
        bool operator > (Student obj) const{
            if(this->Get_First_name().compare(obj.Get_First_name()) > 0){
                return true;
            }
            if(this->Get_Last_name().compare(obj.Get_Last_name()) > 0){
                return true;
            }
            return false;
        }
